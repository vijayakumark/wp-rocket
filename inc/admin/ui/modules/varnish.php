...
add_settings_field(
	'rocket_do_caching_files',
	__( 'WP Rocket Caching Files:', 'rocket' ),
	'rocket_field',
	'rocket_varnish',
	'rocket_display_main_options',
	array(
		array(
			'type'         => 'checkbox',
			'label'        => __('Disable the HTML caching files generated by WP Rocket.', 'rocket' ),
			'label_for'    => 'do_caching_files',
			'label_screen' =>__( 'Caching Files:', 'rocket' ),
		),
		array(
			'type'         => 'helper_description',
			'name'         => 'do_caching_files',
			'description'  => __( '<strong>Note:</strong> By default, WP Rocket creates a HTML caching file for each cached pages. When you are using a caching server like Varnish to cache your website pages, you don\'t need anymore to generate these HTML caching pages by WP Rocket.', 'rocket' ),
		),
	)
);
